...
2. Создание модели «снэпшота».

3. Выполнение необходимых настроек.

4. Запуск «снэпшота».

### Определение источника

В качестве источника для «снэпшотов» используются модели staging-слоя. На примере имеющихся исходных моделей проекта можно отследить изменение с течением времени контактной информации заказчиков (`stg_pg__customers`).