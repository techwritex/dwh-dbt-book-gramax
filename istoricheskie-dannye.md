...
Прежде чем приступить к настройке и созданию модели «снэпшота», стоит отметить один интересный момент. До версии dbt™ 1.9 существовала возможность конфигурации «снэпшотов» только через SQL синтаксис. Но начиная с версии 1.9, можно обойтись  настройками с помощью YAML.