...
Так как с помощью тестов мы хотим упростить себе жизнь и этих тестов может быть достаточно большое количество. Да, ранее было отмечено, что название теста должно отражать его суть, но дополнительные уточняющие комментарии не помешают. Для этого применяются настроечные YAML-файлы.
