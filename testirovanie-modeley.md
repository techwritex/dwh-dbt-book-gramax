...
<image src="./testirovanie-modeley-8.png" title="Рисунок 51. Настройка для пользовательского универсального теста (custom generic test) " crop="0,0,100,100" objects="square,52.082,48.9399,27.5338,11.8375,,top-left" width="1616px" height="1012px" float="center"/>
...
<image src="./testirovanie-modeley-10.png" title="Рисунок 53. Добавление новой логики в существующую модель (оплата)" crop="0,0,100,100" objects="square,54.3771,55.1793,42.9854,20.1195,,top-left" width="1854px" height="1066px" float="center"/>
...
<image src="./testirovanie-modeley-13.png" title="Рисунок 56. Запуск модульного теста (unit tests) для конкретной модели с ошибкой " crop="0,0,100,100" objects="square,3.5438,56.4753,21.134,24.9666,,top-left" width="1552px" height="749px" float="center"/>
