...
Папка `tests` используется для хранения SQL-файлов (select-запросов) для тестирования моделей, источников данных, «сидов» (CSV-файлов со статическими данными), слепков данных («снэпшотов»).
