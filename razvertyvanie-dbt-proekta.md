...
![](./razvertyvanie-dbt-proekta-2.png "Рисунок 3. Репозиторий готов к дальнейшей работе"){width=780px height=562px}

Скопируйте ссылку на созданный репозиторий:

![](./razvertyvanie-dbt-proekta-10.png "Рисунок 4. Клонирование репзитория"){width=755px height=566px}

Клонируйте репозиторий на ваш компьютер с помощью следующей команды:

```bash
git clone https://github.com/techwritex/carsharing-dbt.git
git clone <remote repository URL>
```

### **Создание проекта**

Для создания dbt-проекта вернитесь в командную строку на вашем компьютере и перейдите в папку, в которой вы планируете разместить проект.
...
После выполнения команды в выбранной папке будет создан проект с заданным именем (папка с именем проекта **carsharing**).
