...
После успешной установки откройте папку с  Airflow (определяется переменной окружения `$AIRFLOW_HOME`) в среде разработки и создайте папку `dags`. В данной папке будут храниться DAG-файлы (пайплайны).

<image src="./orkestraciya-zadach.png" title="Рисунок" crop="0,0,100,100" objects="square,6.3617,22.9682,14.688,7.0671,,top-left" width="1398px" height="740px" float="center"/>
