...
8. Apache Airflow - бесплатная платформа с открытым исходным кодом для программирования, планирования и мониторинга рабочих процессов в виде кода.

9. Lightdash - платформа бизнес-аналитики (BI) с открытым исходным кодом, разработанная специально для команд, использующих dbt™.
...
В текущей версии руководства (\<= 1.3), не считая GitHub, в облаке используется база данных (Yandex Managed Service for PostgreSQL) и Lightdash, развернутый на виртуальной машине Yandex Cloud.
