...
Поздравляю! Вы построили хранилище данных в парадигме Кимбалла с помощью dbt&trade;!

Теперь данные можно анализировать, например, с помощью различных BI-инструментов (или при желании через SQL-запросы). Но это отдельная тема, а сейчас время запустить движок dbt&trade; для сохранения новых объектов в хранилище.
