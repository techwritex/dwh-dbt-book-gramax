...
Так как в ходе учебного проекта вы дополнительно документировали только две модели, то можно перейдите в одну из них для более наглядного получения результата. Структура описания для всех моделей одинакова. 

Откройте в иерархии проекта модель `carsharing/models/marts/finance/fct_payments`:
