...
![](./sozdanie-modeley-promezhutochnogo-sloya-intermed-14.png "Рисунок 36. Зависимость моделей проекта"){width=1269px height=853px}
...
dbt предоставляет возможность настройки пользовательской заливки. Эти настройки рассмотрены в разделе «Документирование».
