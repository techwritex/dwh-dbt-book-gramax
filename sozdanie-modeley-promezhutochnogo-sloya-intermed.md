...
DAG является частью функциональности dbt по автоматической генерации документации, с которой более подробно вы познакомитесь в отдельном разделе. Сейчас сфокусируйтесь именно на визуализации связей между моделями проекта.
...
![](./sozdanie-modeley-promezhutochnogo-sloya-intermed-10.png "Рисунок №. Создание документации проекта"){width=1273px height=413px}
...
<image src="./sozdanie-modeley-promezhutochnogo-sloya-intermed-11.png" title="Рисунок №. Результат выполнения команды по созданию документации" crop="0,0,100,100" objects="square,9.9343,66.8845,29.5567,5.3377,,top-left&square,10.0985,81.4815,29.3924,4.793,,top-left" width="1218px" height="918px"/>

Но на этом еще не всё. «Из коробки» dbt позволяет сформировать документацию в виде локального статического сайта (запуск того самого `index.html`) по адресу <http://localhost:8080>.
...
![](./sozdanie-modeley-promezhutochnogo-sloya-intermed-12.png "Рисунок №. Запуск статического сайта с документацией"){width=993px height=413px}

Можете немного ознакомиться со структурой сайта, но пока не будем вдаваться в подробности. Более детально рассмотрим документацию в соответствующем разделе. Сейчас же сфокусируйтесь именно на линейном графе.

Нажмите на икону просмотра графика в правом нижнем углу.

<image src="./sozdanie-modeley-promezhutochnogo-sloya-intermed-13.png" title="Рисунок №. Статический сайт с документацией к проекту" crop="0,0,100,100" objects="square,88.8889,86.4507,9.6521,11.6348,,top-left" width="891px" height="679px"/>

![](./sozdanie-modeley-promezhutochnogo-sloya-intermed-14.png "Рисунок №. Зависимость моделей проекта"){width=1269px height=853px}
...
dbt предоставляет возможность настройки пользовательской заливки.

Эти настройки будут рассмотрены в отдельной главе.
...
<image src="./sozdanie-modeley-promezhutochnogo-sloya-intermed-15.png" title="Рисунок №. Анализ потока для конкретной модели" crop="0,0,100,100" objects="square,32.7545,50.3538,15.075,7.1934,,top-left" width="1267px" height="848px"/>
