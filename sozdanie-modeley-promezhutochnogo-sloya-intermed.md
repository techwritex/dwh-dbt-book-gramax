...
С точки зрения ознакомления с возможностями dbt второй вариант более интересный, поэтому в части создания календаря остановимся на нем.
...
<image src="./sozdanie-modeley-promezhutochnogo-sloya-intermed-7.png" title="Рисунок №. Добавление в структуру проекта папки с библиотеками." crop="0,0,100,100" objects="square,4.838,22.0848,36.4461,7.5972,,top-left" width="1532px" height="932px"/>
...
Дело в том, что на уровне отдельной модели также можно выполнить конфигурацию `config()`, которая переписывает настройки проекта (в части конкретной модели).
...
![](./sozdanie-modeley-promezhutochnogo-sloya-intermed-8.png "Рисунок №. Промежуточная модель календаря"){width=1800px height=934px}
