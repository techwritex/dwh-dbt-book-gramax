...
Первый вариант достаточно простой и понятный.  С точки зрения ознакомления с возможностями dbt второй вариант более интересный, поэтому остановимся на нем.
...
Существует огромное количество полезных библиотек, созданных сообществом. Портал, где представлены библиотеки, называется [Package Hub](https://hub.getdbt.com).
