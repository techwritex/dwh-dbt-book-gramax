...
-  воспользоваться готовой библиотекой сообщества dbt.

Первый вариант достаточно простой и понятный. Возможно, добавлю его позднее при обновлении ресурса. С точки зрения ознакомления с возможностями dbt второй вариант более интересный, поэтому на нем и остановимся. 
