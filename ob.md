...
|-------------------------|--------------------------------------------------------------|--------------------------------------------------------------------|
| Проверка окружения      | `dbt --version`                                              | Версии ядра и адаптера могут не совпадать, это норма               |
...
| Синхронизация библиотек | `dbt deps`                                                   | Скачивает макросы под текущую версию движка                        |
